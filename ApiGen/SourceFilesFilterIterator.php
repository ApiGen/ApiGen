...
class SourceFilesFilterIterator extends RecursiveFilterIterator
{
	 ...
	 * @param \Apigen\Config\Configuration $excludeMasks File/directory exlude masks
	 */
	public function __construct(RecursiveDirectoryIterator $iterator, Config\Configuration $excludeMasks)
	{
