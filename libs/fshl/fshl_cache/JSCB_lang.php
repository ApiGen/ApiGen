 ...
 *
 *   Source language file: W:\fshl/lang/JSCB_lang.php
 *       Language version: 1.2 (Sign:SHL)
 *
 *            Target file: W:\fshl/fshl_cache/JSCB_lang.php
...
function JSCB_lang () {
	...
	$this->delim=array(0=>array(0=>"_COUNTAB",1=>"ALPHA",2=>".",3=>"NUMBER",4=>"\"",5=>"'",6=>"/*",7=>"//",8=>"<?php",9=>"<?",10=>"{",11=>"</"),1=>array(0=>"!SAFECHAR"),2=>array(0=>"x",1=>".",2=>"!NUMBER",3=>"NUMBER"),3=>array(0=>".",1=>"!NUMBER"),4=>array(0=>"!HEXNUM"),5=>array(0=>"\"",1=>"<?php",2=>"<?"),6=>array(0=>"'",1=>"<?php",2=>"<?"),7=>array(0=>"_COUNTAB",1=>"*/",2=>"<?php",3=>"<?"),8=>array(0=>"\x0a",1=>"_COUNTAB",2=>"<?php",3=>"<?"),9=>null,10=>null,12=>null);
	$this->ret=11;
	$this->quit=12;
