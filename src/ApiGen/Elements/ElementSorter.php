...
class ElementSorter extends Nette\Object
{
	...
	/**
	 * @param ReflectionConstant[]|ReflectionFunction[]|ReflectionMethod[]|ReflectionProperty[]|array $elements
	 * @return ReflectionConstant[]|ReflectionFunction[]|ReflectionMethod[]|ReflectionProperty[]|array
	 */
	...
	{
		usort($constants, array($this, 'compareConstantsByFqn'));
		return $constants;
	}
	...
	{
		usort($functions, array($this, 'compareFunctionsByFqn'));
		return $functions;
	}
	...
	{
		usort($methods, array($this, 'compareMethodsOrPropertiesByFqn'));
		return $methods;
	}
	...
	{
		usort($properties, array($this, 'compareMethodsOrPropertiesByFqn'));
		return $properties;
	}
